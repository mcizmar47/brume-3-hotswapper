...
public class ReadOnlyPreflightTests
{
    ...
    [InlineData("/root/hotswapper/install-gl-guard.sh --check")]
    [InlineData("/root/hotswapper/install-gl-guard.sh --install")]
    [InlineData("/root/hotswapper-main.sh status")]
    [InlineData("/root/hotswapper-supervisor.sh --installer")]
